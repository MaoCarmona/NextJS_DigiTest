...
const create = async (conductor) => {
  try {
    ...
    return "statusCode : 200 OK  Conductor Creado con Exito";
  } catch (err) {
...
const update = async (id, conductor) => {
  try {
    ...
    return "statusCode : 200 OK  Conductor Actualizado con Exito";
  } catch (err) {
...
const deleteById = async (id) => {
  try {
    ...
    return "statusCode : 200 OK  Conductor Eliminado con Exito";
  } catch (err) {
...
export default { getAll, create, update, deleteById ,getCerca,getById,getDisponibles};